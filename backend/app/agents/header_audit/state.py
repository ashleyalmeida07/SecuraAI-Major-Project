...
class HeaderAuditState(TypedDict):
    ...
    Keys:
        ...
        checklist_results: Every checklist item evaluated per endpoint
                           (pass/fail/missing) — the deterministic output.
        scored_findings:   The fail/missing subset after LLM severity scoring.
