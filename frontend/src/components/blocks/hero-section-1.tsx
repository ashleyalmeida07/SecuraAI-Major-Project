...
import { ArrowRight, ChevronRight, Menu, X, Shield, Lock, Server, Globe, Activity, Code, Database, Fingerprint } from "lucide-react";
      ...
      <main className="overflow-hidden">
        ...
        <section>
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=3276&auto=format&fit=crop"
                alt="background"
                className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block opacity-20 object-cover"
                width="3276"
                height="4095"
              />
            </AnimatedGroup>
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Introducing LangGraph Static Analysis
                    </span>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Link href="/scan">
                        <span className="text-nowrap">Start Scanning</span>
                      </Link>
                    </Button>
                  </div>
                  <Button
              ...
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=2700&auto=format&fit=crop"
                    alt="app screen dark"
                    width="2700"
                    height="1440"
                  />
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=2700&auto=format&fit=crop"
        ...
        {/* Core Capabilities */}
        <section className="bg-background pb-16 pt-16 md:pb-32" id="how-it-works">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              ...
              >
                <span className="bg-background border px-4 py-2 rounded-full shadow-lg">Try all capabilities</span>
              </Link>
            </div>
            <div className="text-center mb-8 text-muted-foreground text-sm tracking-widest uppercase font-semibold">
              Comprehensive Security Architecture
            </div>
            <div className="group-hover:blur-sm mx-auto grid max-w-2xl grid-cols-2 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:grid-cols-4 sm:gap-x-16 sm:gap-y-14">
              
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                <Globe className="h-8 w-8 text-cyan-400" />
                <span className="text-xs font-medium">Recon & Mapping</span>
              </div>
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                <Lock className="h-8 w-8 text-orange-400" />
                <span className="text-xs font-medium">Header Audits</span>
              </div>
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                <Code className="h-8 w-8 text-purple-400" />
                <span className="text-xs font-medium">Static Analysis</span>
              </div>
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
              ...
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                ...
                <span className="text-xs font-medium">Semgrep Rules</span>
              </div>
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
              ...
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                ...
                <span className="text-xs font-medium">Auth Tracking</span>
              </div>
              <div className="flex flex-col items-center gap-3 text-muted-foreground">
                <Server className="h-8 w-8 text-red-400" />
                <span className="text-xs font-medium">LangGraph AI</span>
              </div>
